...
if (isset($_POST['pesquisaExemplarR']) && !empty($_POST['pesquisaExemplarR']) && isset($_POST['consultaExemplarR']) ){
...
$pesquisa=$_POST["pesquisaExemplarR"];
$_SESSION['pesquisaExemplarR'] = $pesquisa;
...
<div class="novadivremov">
    <form class="row g-3 catform" action="dadosExemplarR.php" method="POST">
    <div class="col-12">
        <button type="submit" class="btn btn-primary">Remover Exemplar</button>
    </div>
    </form>
</div>
