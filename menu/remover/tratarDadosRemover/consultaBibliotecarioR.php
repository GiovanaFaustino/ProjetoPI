...
if (isset($_POST['pesquisaBibliotecarioR']) && !empty($_POST['pesquisaBibliotecarioR']) && isset($_POST['consultaBibliotecarioR']) ){
...
$pesquisa=$_POST["pesquisaBibliotecarioR"];
$_SESSION['pesquisaBibliotecarioR'] = $pesquisa;
...
<div class="novadivremov">
    <form class="row g-3 obrform" action="dadosBibliotecarioR.php" method="POST">
    <div class="col-12">
        <button type="submit" class="btn btn-primary">Remover Bibliotecário</button>
    </div>
